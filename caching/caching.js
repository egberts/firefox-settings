...
// NOTICE: You can not view or inspect cookies when in private browsing:
// https://bugzilla.mozilla.org/show_bug.cgi?id=823941
// NOTICE: When Javascript is enabled, Websites can detect use of Private
// Browsing mode
// NOTICE: Private browsing breaks Kerberos authentication
// NOTICE: Disables "Containers" functionality (see below)
// NOTICE: "Always use private browsing mode"
// (browser.privatebrowsing.autostart) disables the possibility to use password
// manager:
// https://support.mozilla.org/en-US/kb/usernames-and-passwords-are-not-saved#w_private-browsing
...
// NOTICE: Installing user.js will remove your browsing history, caches and
// local storage.
// NOTICE: Installing user.js **will remove your saved passwords**
// (https://github.com/pyllyukko/user.js/issues/27)
// NOTICE: Clearing open windows on Firefox exit causes 2 windows to open
// when Firefox starts https://bugzilla.mozilla.org/show_bug.cgi?id=1334945
...
//
// PREF: Disable form autofill, don't save information entered in web page
...
// PREF: Require manual intervention to autofill known username/passwords
// sign-in forms
...
// PREF: When username/password autofill is enabled, still disable it on
// non-HTTPS sites
...
// OWASP ASVS V9.1
// Does not prevent any kind of auto-completion (see browser.formfill.enable,
...
// PREF: Do not create screenshots of visited pages (relates to the "new tab
// page" feature)
...
//
// PREF: Don't fetch and permanently store favicons for Windows .URL
// shortcuts created by drag and drop
